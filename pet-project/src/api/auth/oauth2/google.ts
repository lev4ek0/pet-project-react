...
import { GoogleLinkAPIResponseBody, GoogleLoginAPIRequestBody, GoogleLoginAPIResponseBody } from "@/types/auth/oauth2/google";
import { AppRouterInstance } from "next/dist/shared/lib/app-router-context.shared-runtime";

export default async function googleLinkAPI(isPrivate: boolean, router: AppRouterInstance | undefined = undefined) {
    ...
    if (isPrivate && router) {
        return await privateAPIRequest<GoogleLinkAPIResponseBody>(requestOptions, router)
    }
